...
- Open an [Issue](https://github.com/TheEinzzCookie/Windows-11-Optimizer/issues/new/choose).
...
- Open an [Issue](https://github.com/TheEinzzCookie/Windows-11-Optimizer/issues/new/choose). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/TheEinzzCookie/Windows-11-Optimizer/issues).
